  ...
  return (
    <div id='/Projects' className='p-20 flex flex-col items-center justify-center'>
      ...
      <div className='grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 justify-around gap-10'>
        <a href="https://responsive-blog-green.vercel.app" target="_blank" rel="noopener noreferrer">
        ...
        <a href="https://restaurant-ten-neon.vercel.app" target="_blank" rel="noopener noreferrer">
        ...
        <a href="https://news-website-nu-seven.vercel.app" target="_blank" rel="noopener noreferrer">
